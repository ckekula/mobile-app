...
class EditVendorProfilePage extends StatefulWidget {
  ...
  const EditVendorProfilePage({super.key, required this.user});

  @override
  State<EditVendorProfilePage> createState() => _EditProfilePageState();
}

class _EditProfilePageState extends State<EditVendorProfilePage> {
  //mobile image pick
  ...
  void updateProfile() async {
    // profile cubit
    final profileCubit = context.read<VendorProfileCubit>();
  ...
  Widget build(BuildContext context) {
    // SCAFFOLD
    return BlocConsumer<VendorProfileCubit, VendorProfileState>(
